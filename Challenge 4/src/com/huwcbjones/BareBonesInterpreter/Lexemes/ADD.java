 ...
 */
public class ADD implements Lexeme {
    private final int _numberOfArgs = 3;
    private final String _lexeme = "ADD";
    ...
    public String getHelp() {
        ...
        helpTextBuilder.append("Usage: Adds two variables and puts the result in another variable.\n");
        helpTextBuilder.append("       The destination variable does not need to be cleared.\n");
        helpTextBuilder.append("ADD uses the format: ADD {ARG1} {ARG2} {DEST};\n");
